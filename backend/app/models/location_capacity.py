...
class LocationCapacityRule(TimestampMixin, Base):
    ...
    __table_args__ = (UniqueConstraint("location_id", "reservation_type", name="uq_capacity_location_type"),)
    ...
    location: Mapped["Location"] = relationship("Location", back_populates="capacity_rules")
